...
$$\frac{\vec{z}}{\vec{x}} = \begin{bmatrix} \frac{\partial z_1}{\partial x_1} & \frac{\partial z_1}{\partial x_2} & \cdots & \frac{\partial z_1}{\partial x_n} \\
...
Now let $z = V^top x$ and $\hat b = U ^ \top b$ then we have:
