...
This year I have been learning more publishing and coding techniques that are designed to make sharing technical work easier, more visual, and more interactive. Micheal Friedlander, who teaches CPSC 406 at UBC, is a proponent of using Julia and Quarto for teaching and research. Taking some inspiration from his work along with [Patrick Altmeyer](https://www.paltmeyer.com/blog/)'s website, I have decided to start my own blog using Quarto.
...
Here is a snail-like surface that is parametrically defined. Despite living in 3D space, a surface can be two dimensional in the sense that we can specify any location on it using just two coordinates. Think about the surface of the earth that we live on.
