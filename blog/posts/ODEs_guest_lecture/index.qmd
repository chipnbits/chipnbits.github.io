---
title: "Numerical Methods for Deep Learning"
subtitle: "Ordinary Differential Equations"
date: 2026-02-12
author: "Simon Ghyselincks"
description: >-
    A guest lecture and workshop exploring the intersection of deep learning and numerical analysis. It begins with an onramp to deep learning for practitioners of numerical methods. We look at neuro differential equations with architectures such as ResNet and RevNet which resemble integration schemes for ODEs. Finally we look at neural ODEs where a continuous time dynamical system is modeled by a neural network, with an application to generative AI and inverse problems.
categories:
    - Deep Learning
    - Numerical Methods
...
format:
  html:
    ...
    number-depth: 1             # Stops numbering at X.X (excludes X.X.X)
...
| :--- | :--- | :--- |
| **Part 1** | Machine Learning Background Primer | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1xbifVi22fIjH2u8Ip_uKRjx-fdk0IPSB?usp=sharing) |
| **Part 2** | Neuro Differential Equations | Future Work |
| **Part 3** | Generative AI Exercise | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/19ZAUiukAFUCfIM3FpsitM7XIGeJa9-hz?usp=sharing) |

# Presentation Slides and Notes

![Slide 1](slide%20pngs/Slide1.PNG)
...
![Slide 2](slide%20pngs/Slide2.PNG)

<!-- Notes for Slide 2 -->

![Slide 3](slide%20pngs/Slide3.PNG)
...
![Slide 4](slide%20pngs/Slide4.PNG)
...
### Part 1
![Slide 5](slide%20pngs/Slide5.PNG)

<!-- Notes for Slide 5 -->

![Slide 6](slide%20pngs/Slide6.PNG)
...
![Slide 7](slide%20pngs/Slide7.PNG)
...
![Slide 8](slide%20pngs/Slide8.PNG)
...
![Slide 9](slide%20pngs/Slide9.PNG)
...
![Slide 10](slide%20pngs/Slide10.PNG)
...
![Slide 11](slide%20pngs/Slide11.PNG)

MLP We have reached deep learnin with more than one hidden layer. 
The output from the SLP is passed as the input to another SLP and so on
We simply continue with more hidden layers. This forms a composition of many functions, basis functions of basis functions. Deep here refers to the depth of layers vs breadth of a single layer. This can solve advanced problems but is difficult to work with as the number of layers increases.
...
![Slide 12](slide%20pngs/Slide12.PNG)
...
![Slide 13](slide%20pngs/Slide13.PNG)

The Residual Network (ResNet), introduced by @he2015resnet, was a groundbreaking paper.  Why don’t I only model the difference across layers? Use the network itself to model the differences. This introduced the *skip connection*, which explicitly bypasses layers of the model. 

ResNet was ground-breaking:
- Halved error of previous SOTA models
- First to beat human-level on visual recognition
- It beat benchmarks across many different tasks, taking over the leaderboards 
- Previous contenders: 19-22 layers compared to ResNet 152 layers, made deep learning DEEP
- Still used as a backbone in many models
- One of the most import papers to computer vision and machine learning for the last while
- The layers between skip connections may vary (point to bottom image)

Question: Where have we seen this relation before?
This looks like an ODE if we add an h infront

![Slide 14](slide%20pngs/Slide14.PNG)

ResNet is fundamentally a series of additive changes. It can be viewed as an Initial Value Problem (IVP), mapping a dynamical system where the hidden state is gradually pushed along a path [@Haber_2017]. Because each layer has different weights, it is a time-variant field where each "time step" features different dynamics.
...
![Slide 15](slide%20pngs/Slide15.PNG)
...
![Slide 17](slide%20pngs/Slide17.PNG)
...
![Slide 18](slide%20pngs/Slide18.PNG)

We can propose physics-informed architectures as shown by @ruthotto2018deepneuralnetworksmotivated.
...
![Slide 19](slide%20pngs/Slide19.PNG)
...
![Slide 20](slide%20pngs/Slide20.PNG)

Going back to the Hamiltonian network, this is the inspiration for using symplectic integration. This is a semi-implicit method, as the updated value for $y_1 = x_1$ is used in the middle of the two step process.
Also has energy conservation properties, reversible, memory efficient– serves as an alternative to leapfrog
Used in a lot of research including a recent paper from our group on LLMs, [@gal2025llms].

![Slide 21](slide%20pngs/Slide21.PNG)


![Slide 22](slide%20pngs/Slide22.PNG)
...
This gives us the integral equation, we use a Neural ODE [@chen2019neuralODEs] to learn the velocity field directly. Some variants are not time dependent such as Deep Equilibrium models (DEQs) [@bai2019deepequilibriummodels]. Some have a “time-embedding” that conveys the continuous time throughout the learning model. For inference we simply integrate the learned function using a numerical solver. This offers many approaches for handling the computation, choice of ODE integrator. What sort of integrators can we use for an arbitrary function?

![Slide 23](slide%20pngs/Slide23.PNG)
...
Solution: instead what we do is “push” samples from a known distribution (Gaussian) to our target distribution through a velocity field [@lipman2024flowmatchingguidecode].
This avoids the partition function.


![Slide 24](slide%20pngs/Slide24.PNG)

- I give a brief overview of the algorithm, this part is not important to understand, it is the training regime.


![Slide 25](slide%20pngs/Slide25.PNG)

- We have learned a push velocity field so now we deploy numerical integration on IVP samples from source distribution!


![Slide 26](slide%20pngs/Slide26.PNG)

This is a good point to refer to the notebook to experiment with ODE integration on a generative task

### Part 3

![Slide 27](slide%20pngs/Slide27.PNG)

Now I present some of my recent work that uses a neural ODE to perform geological inverison [@ghyselincks2026syntheticgeologystructuralgeology]

![Slide 28](slide%20pngs/Slide28.PNG)
...
![Slide 29](slide%20pngs/Slide29.PNG)
...
![Slide 30](slide%20pngs/Slide30.PNG)
...
![Slide 31](slide%20pngs/Slide31.PNG)
...
![Slide 32](slide%20pngs/Slide32.PNG)
...
![Slide 33](slide%20pngs/Slide33.PNG)
